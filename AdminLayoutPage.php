...
EOT;
            ...
            $result .= <<<EOT
                       ...
                       <!--  <ul>
                        ...
                        <li>
                                <!--<h2>Archives</h2>-->
                                <h2><a href="AdminHomePage.php">ADMIN</a></h2>
                                <ul>
                                        <li><a href="AdminEdit.php">Edit User</a>(23)</li>
                                        <li><a href="SearchUser.php">Search</a> (31)</li>
                                        <li><a href="UploadVideo.php">Video Upload</a> (31)</li>
                                        <li><a href="AddNewBlog.php">File Upload</a> (30)</li>
                                        <li><a href="registerpage.php">Register</a> (31)</li>
                                        <li><a href="BlogList.php">All Blogs</a> (30)</li>
                                        <li><a href="AboutPage.php">About Us</a> (31)</li>          
                                </ul>
