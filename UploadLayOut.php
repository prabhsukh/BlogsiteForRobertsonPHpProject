...
EOT;
                ...
                if ($_SESSION["AccessLevelID"] == '1') {
                    $result .= '<li><a href="AdminHomePage.php" accesskey="5" title="">Admin</a></li>';
                }
                else
                {
                    $result .= '<li><a href="FirstPage.php" accesskey="5" title="">About Us</a></li>';
                }
            ...
            $result .=<<<EOT
                        ...
                        <div id="gallery">
                                <div id="top-photo">
                                        <p><a href="#"><img src="images/pic1.jpg" alt="" width="830" height="300" /></a></p>
                                </div>
                        </div>
